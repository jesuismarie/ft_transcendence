...
export class FriendListItem extends StatelessWidget {
    ...
    build(context: BuildContext): Widget {
        ...
        <div id="friend-details-btn" class="px-4 py-3 hover:bg-gray-50 flex items-center gap-3 cursor-pointer">
			<img src="${this.avatarUrl ?? "/images/background1.jpg"}" crossOrigin="anonymous" onerror="this.onerror=null; this.src='/images/background1.jpg';" alt="${this.username}'s avatar" class="w-10 h-10 rounded-full object-cover" />
