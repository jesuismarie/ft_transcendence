...
// }
//
// export function renderSearchItem(context: BuildContext, user: QuickUserResponse): string {
...
// 	// const currentUser = profileLogic.state.profile?.username
// 	// const targetHash = user.username === currentUser ? "#profile" : `#profile/${user.username}`;
// 	return `
// 		<div onclick="" class="px-4 py-3 hover:bg-gray-50 flex items-center gap-3 cursor-pointer">
...
// }
//
// export function renderSearchResults(users: QuickUserResponse[], container: HTMLElement) {
...
// }
//
// export function addSearchPaginationEvents(
// 	searchInput: HTMLInputElement,
// 	paginationInfo: PaginationInfo,
// 	modalInfo: ModalInfo
// ) {
