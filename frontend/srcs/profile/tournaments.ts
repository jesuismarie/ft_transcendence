...
function renderTournamentItem(tournament: TournamentInfo, username: string | null): string {
...
function renderTournamentResults(data: GetTournamentsInfoResponse, modalInfo: ModalInfo, offset: number, username: string | null) {
...
function addTournamentPaginationEvents(
	username: string | null,
	paginationInfo: PaginationInfo,
	modalInfo: ModalInfo
) {
...
function addTournamentButtonListeners(username: string | null) {
