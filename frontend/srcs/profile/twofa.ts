...
async function initiate2FASetup(container: HTMLElement) {
...
async function requestQRCode(): Promise<TwoFAEnableResponse> {
...
function displayQRCode(container: HTMLElement, data: TwoFAEnableResponse) {
	container.innerHTML = `
...
function setupVerificationHandler(container: HTMLElement) {
...
async function verify2FAToken(container: HTMLElement, tokenInput: HTMLInputElement) {
