...
function viewFriends(id: number) {
...
function renderFriendResults(data: FriendResponse, modalInfo: ModalInfo, offset: number) {
...
function addFriendPaginationEvents(
	id: number,
	paginationInfo: PaginationInfo,
	modalInfo: ModalInfo
) {
