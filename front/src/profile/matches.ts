...
export function viewMatches(id: number, username: string | null) {
...
export function getMatchElements(): {
	modalInfo: ModalInfo;
...
export function renderMatchItem(match: MatchHistory, username: string | null): string {
	return `
...
export function renderMatchResults(data: GetMatchHistoryResponse, modalInfo: ModalInfo, offset: number, username: string | null) {
...
export function addMatchPaginationEvents(
	username: string | null,
	paginationInfo: PaginationInfo,
	modalInfo: ModalInfo
) {
